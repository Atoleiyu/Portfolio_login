  ...
  <div class="container">
    ...
    <form action="" method="post" class="row">
      <div class="col-sm-8 col-sm-offset-2">
        <p>こちらでは、会員情報の編集が行えます。<br>必要事項を以下のフォームに入力してください。</p>
        ...
        <div class="form-group">
          ...
          <div class="form-inline inputName">
            <input type="text" id="name" name="lastName" class="form-control" value="<?php echo(htmlspecialchars($_SESSION['lastName'], ENT_QUOTES)); ?>" placeholder="例）山田">
            <input type="text" id="name" name="firstName" class="form-control" value="<?php print(htmlspecialchars($_SESSION['firstName'], ENT_QUOTES)); ?>" placeholder="例）太郎">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="form-inline inputName">
            <input type="text" id="name" name="lastFurigana" class="form-control" value="<?php print(htmlspecialchars($_SESSION['lastFurigana'], ENT_QUOTES)); ?>" placeholder="例）ヤマダ">
            <input type="text" id="name" name="firstFurigana" class="form-control" value="<?php print(htmlspecialchars($_SESSION['firstFurigana'], ENT_QUOTES)); ?>" placeholder="例）タロウ">
          </div>
        </div>
